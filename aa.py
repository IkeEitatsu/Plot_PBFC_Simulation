...
plt.plot(voltage_A, power_density_A, label="Before optimization", color="b")
plt.plot(voltage_B, power_density_B, label="After topology optimization", color="g")
plt.plot(voltage_C, power_density_C, label="After shape optimization", color="r")

plt.xlabel("Applied voltage [V]", fontsize = 14)
plt.ylabel("Output power density [uW/cm2]", fontsize = 14)
plt.title("Output power density change by optimization", fontsize = 18)
